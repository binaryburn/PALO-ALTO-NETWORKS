...
exports.checkAndUpdate = function(paloIp, paloAdmin, paloPw, elbItem, callback){
    let currentELBIp = '';
    ...
    async.waterfall([
        ...
        function getNATRuleCurrentIP(val, callback){
            palo.getCurrentDestination(elbItem.RuleName, paloIp, paloAdmin, paloPw, function(err, result){
        ...
        if(currentNatRuleIp != 'rule not found' && currentNatRuleIp == currentELBIp){
            ...
            palo.updateNATRule(elbItem.RuleName, paloIp, paloAdmin, paloPw, currentELBIp, function(err, updateResult){
